...
<div class="content-box">
    ...
    <?= form_open_multipart('product/new_submit', ['novalidate' => true]) ?>
        ...
        <div class="col-lg-6 col-12 p-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_name" id="text_name"
                    class="form-control" placeholder="Nome do produto" value="<?= old('text_name') ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_description" id="text_description"
                    class="form-control" placeholder="Descrição do produto" value="<?= old('text_description') ?>">
                ...
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input list="list_categories"
                            ...
                            id="text_category"
                            class="form-control"
                            placeholder="Categoria" value="<?= old('text_category') ?>">
                ...
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="text_price" id="text_price"
                            class="form-control" placeholder="Preço" value="<?= old('text_price') ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_promotion"
                        id="text_promotion"
                        class="form-control"
                        placeholder="Promoção" value="<?= old('text_promotion') ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_initial_stock"
                        id="text_initial_stock"
                        class="form-control"
                        placeholder="Estoque inicial" value="<?= old('text_initial_stock') ?>">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_stock_minimum_limit"
                        ...
                        class="form-control"
                        placeholder="Limite mínimo de estoque" value="<?= old('text_stock_minimum_limit') ?>">
